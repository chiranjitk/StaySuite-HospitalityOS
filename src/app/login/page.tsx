        ...
        >
          ...
          <motion.div className="flex items-center gap-3" variants={headerVariants}>
            ...
            <div>
              ...
              <p className="text-slate-400 text-xs">by Cryptsk Pvt Ltd</p>
            </div>
          </motion.div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      ...
                      >
                        ...
                        <div className="relative group/input">
                          <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/30 transition-all duration-300 group-focus-within/input:text-violet-500 group-focus-within/input:scale-110" />
                      ...
                      >
                        <div className="flex items-center">
                          ...
                          <button
                            type="button"
                            className="ml-auto text-xs text-muted-foreground hover:text-violet-600 dark:hover:text-violet-400 transition-colors duration-200 font-medium"
                            onClick={async () => {
                              if (!email) {
                                toast({
                        ...
                        <div className="mt-1 relative group/input">
                          <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground/30 transition-all duration-300 group-focus-within/input:text-violet-500 group-focus-within/input:scale-110" />
                          <div className="absolute inset-0 rounded-xl bg-violet-500/0 blur-sm transition-all duration-300 group-focus-within/input:bg-violet-500/5 group-focus-within/input:blur-md pointer-events-none" />
                          <Input
                            id="password"
