          ...
          <div className="flex items-stretch gap-4">
            ...
            <div className="flex flex-col items-center justify-center px-2">
              ...
              <div className="flex items-center gap-1 py-2">
                ...
                <span className="text-xs text-slate-500">{totalDays} nights</span>
              </div>
              <div className="flex-1 w-px bg-slate-200 dark:bg-slate-700" />
            </div>
            ...
            <div className="flex-1 bg-slate-50 dark:bg-slate-800 rounded-xl p-3">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-medium text-slate-600 dark:text-slate-400">Check-out</span>
              </div>
          ...
          <CardContent className="p-4">
            ...
            <div className="bg-violet-50 dark:bg-violet-950/30 rounded-xl p-4 space-y-3">
              ...
              <Button
                variant="outline"
                size="sm"
                className="w-full border-violet-300 dark:border-violet-700 text-violet-600"
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg bg-sky-100 dark:bg-sky-900/30 flex items-center justify-center">
                        <ConciergeBell className="h-4 w-4 text-sky-600" />
                      </div>
                      <div>
                    ...
                    <Badge
                      variant="outline"
                      className={cn(
                        request.status === 'completed' && 'border-emerald-500 text-emerald-600',
                        request.status === 'in_progress' && 'border-amber-500 text-amber-600',
