...
export default function FeedbackPage() {
  ...
  const feedbackTypes = [
    { value: 'compliment', label: 'Compliment', icon: ThumbsUp, color: 'text-emerald-500' },
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <Badge
                      variant="outline"
                      className={cn(
                        item.status === 'resolved' && 'border-emerald-500 text-emerald-600',
                        item.status === 'open' && 'border-amber-500 text-amber-600',
                        item.status === 'in_progress' && 'border-sky-500 text-sky-600'
                      )}
                    >
