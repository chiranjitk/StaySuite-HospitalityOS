    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-violet-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-2">Get started with StaySuite in minutes</p>
        </div>
        ...
        <div className="flex items-center justify-center gap-4 mb-8">
          <div className="flex items-center gap-2">
            <div className={`h-8 w-8 rounded-full flex items-center justify-center text-sm font-medium ${
              step >= 1 ? 'bg-violet-500 text-white' : 'bg-gray-200 text-muted-foreground'
            }`}>
              {step > 1 ? <Check className="h-4 w-4" /> : '1'}
            </div>
            <span className={step >= 1 ? 'text-gray-900 font-medium' : 'text-muted-foreground'}>Account Details</span>
          </div>
          <div className={`h-px w-16 ${step >= 2 ? 'bg-violet-500' : 'bg-gray-200'}`} />
          <div className="flex items-center gap-2">
            <div className={`h-8 w-8 rounded-full flex items-center justify-center text-sm font-medium ${
              step >= 2 ? 'bg-violet-500 text-white' : 'bg-gray-200 text-muted-foreground'
            }`}>
              2
            </div>
            <span className={step >= 2 ? 'text-gray-900 font-medium' : 'text-muted-foreground'}>Select Plan</span>
          </div>
        </div>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex">
                      ...
                      />
                      <div className="flex items-center px-3 bg-gray-100 border border-l-0 rounded-r-md text-muted-foreground text-sm">
                        .staysuite.com
                      </div>
                    </div>
                    {errors.slug && (
                    ...
                    <p className="text-xs text-muted-foreground">Your hotel will be accessible at {formData.slug || 'your-hotel'}.staysuite.com</p>
                  </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Complete PMS with room management, bookings, and more</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="h-8 w-8 rounded-lg bg-violet-100 flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">Guest profiles, preferences, and loyalty programs</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="h-8 w-8 rounded-lg bg-violet-100 flex items-center justify-center flex-shrink-0">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">OTA connections and inventory sync</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-3">
                        <div className="h-8 w-8 rounded-lg bg-violet-100 flex items-center justify-center flex-shrink-0">
