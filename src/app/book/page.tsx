                        ...
                        <div className="flex-1 p-6">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <div className="flex items-center gap-1">
                              {[1, 2, 3, 4, 5].map((star) => (
                                <Star key={star} className="h-4 w-4 text-yellow-400 dark:text-yellow-300 fill-yellow-400" />
                              ))}
                            </div>
                          </div>
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-3">
          <Card className="text-center">
            <CardContent className="pt-6">
              <Shield className="h-8 w-8 mx-auto mb-3 text-teal-600 dark:text-teal-400" />
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <CheckCircle className="h-8 w-8 mx-auto mb-3 text-teal-600 dark:text-teal-400" />
          ...
          <Card className="text-center">
            <CardContent className="pt-6">
              <CreditCard className="h-8 w-8 mx-auto mb-3 text-teal-600 dark:text-teal-400" />
          ...
          {confirmation && (
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                ...
                <p className="text-2xl font-bold text-green-600 dark:text-green-400">{confirmation.booking.confirmationCode}</p>
              </div>
