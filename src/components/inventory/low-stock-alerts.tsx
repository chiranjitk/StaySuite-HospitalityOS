    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-3">
        <Card className="bg-gradient-to-br from-red-50 to-rose-50 dark:from-red-950/20 dark:to-rose-950/20 border-red-200 dark:border-red-800">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-red-700 dark:text-red-300">{criticalItems.length}</div>
            <p className="text-xs text-red-600 dark:text-red-400 mt-1">Below 25% of minimum</p>
          </CardContent>
        </Card>
        <Card className="bg-gradient-to-br from-amber-50 to-yellow-50 dark:from-amber-950/20 dark:to-yellow-950/20 border-amber-200 dark:border-amber-800">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-amber-700 dark:text-amber-300">{warningItems.length}</div>
            <p className="text-xs text-amber-600 dark:text-amber-400 mt-1">25-50% of minimum</p>
          </CardContent>
        </Card>
        <Card className="bg-gradient-to-br from-orange-50 to-amber-50 dark:from-orange-950/20 dark:to-amber-950/20 border-orange-200 dark:border-orange-800">
          ...
          <CardContent>
            <div className="text-2xl font-bold text-orange-700 dark:text-orange-300">{lowItems.length}</div>
            <p className="text-xs text-orange-600 dark:text-orange-400 mt-1">50-100% of minimum</p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent>
          {loading ? (
            ...
            <div className="text-center py-8 text-muted-foreground">
              <Package className="h-12 w-12 mx-auto mb-4 text-emerald-500 dark:text-emerald-400" />
