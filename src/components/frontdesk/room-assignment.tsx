    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-3">
        ...
        <Card className="p-4 border-l-4 border-l-rose-500">
          <div className="text-2xl font-bold text-rose-600">{stats.arriving}</div>
                          ...
                          <div className="flex items-start gap-4 flex-1">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center gap-2 flex-wrap">
                                ...
                                {isArrivingToday && (
                                  <Badge className="bg-amber-100 text-amber-700">Arriving Today</Badge>
                                )}
                              </div>
                    ...
                    <CardContent>
                      <div className="grid gap-3 grid-cols-4 sm:grid-cols-6 lg:grid-cols-8 xl:grid-cols-10">
                        {rooms.map(room => (
                          <div
                            key={room.id}
                            className="relative p-3 rounded-lg border-2 border-emerald-200 bg-emerald-50 text-center"
                          >
                            <div className="text-lg font-bold text-emerald-700">{room.number}</div>
                      ...
                      <div className="grid grid-cols-4 gap-2 pr-2">
                        {compatibleRooms.map(room => (
                          ...
                          >
                            ...
                            {room.hasSeaView && (
                              <Sparkles className="h-3 w-3 mx-auto mt-1 text-cyan-500" />
                            )}
                          </button>
                        ))}
                      </div>
                ...
                <Card className="p-3 border-primary">
                  <div className="flex items-center gap-3">
                    ...
                    {selectedRoom.hasSeaView && (
                      <Badge variant="outline" className="ml-auto text-cyan-600">
