...
const roomStatuses = [
  { value: 'available', label: 'Available', color: 'bg-emerald-500', textColor: 'text-emerald-600 dark:text-emerald-400', bgColor: 'bg-emerald-50 dark:bg-emerald-950/30 border-emerald-200 dark:border-emerald-800' },
  { value: 'occupied', label: 'Occupied', color: 'bg-rose-500', textColor: 'text-rose-600 dark:text-rose-400', bgColor: 'bg-rose-50 dark:bg-rose-950/30 border-rose-200 dark:border-rose-800' },
  { value: 'dirty', label: 'Dirty', color: 'bg-amber-500', textColor: 'text-amber-600 dark:text-amber-400', bgColor: 'bg-amber-50 dark:bg-amber-950/30 border-amber-200 dark:border-amber-800' },
  { value: 'maintenance', label: 'Maintenance', color: 'bg-orange-500', textColor: 'text-orange-600 dark:text-orange-400', bgColor: 'bg-orange-50 dark:bg-orange-950/30 border-orange-200 dark:border-orange-800' },
  { value: 'out_of_order', label: 'Out of Order', color: 'bg-gray-500', textColor: 'text-gray-600 dark:text-gray-400', bgColor: 'bg-gray-50 dark:bg-gray-800 border-gray-200 dark:border-gray-700' },
];
    ...
    <div className="space-y-6">
          ...
          <h2 className="text-xl font-semibold flex items-center gap-2">
            ...
            <div className="flex items-center gap-2 ml-2">
              {connectionStatus.connected ? (
                <Badge variant="outline" className="text-xs gap-1 bg-emerald-50 text-emerald-700 dark:text-emerald-300 border-emerald-200">
                  <Wifi className="h-3 w-3" />
                  Live
                </Badge>
              ) : (
                <Badge variant="outline" className="text-xs gap-1 bg-gray-50 dark:bg-gray-800 text-gray-500 dark:text-gray-400 border-gray-200 dark:border-gray-700">
      ...
      <div className="grid gap-4 grid-cols-2 sm:grid-cols-5">
        ...
        <Card className="p-4 border-l-4 border-l-rose-500">
          <div className="text-2xl font-bold text-rose-600 dark:text-rose-400">{stats.occupied}</div>
          <div className="text-xs text-muted-foreground">Occupied</div>
        </Card>
        <Card className="p-4 border-l-4 border-l-amber-500">
          <div className="text-2xl font-bold text-amber-600 dark:text-amber-400">{stats.dirty}</div>
          <div className="text-xs text-muted-foreground">Dirty</div>
        </Card>
        <Card className="p-4 border-l-4 border-l-orange-500">
          <div className="text-2xl font-bold text-orange-600 dark:text-orange-400">{stats.maintenance}</div>
        ...
        <DialogContent className="w-[95vw] sm:max-w-md max-h-[90dvh] flex flex-col">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2">
              ...
              {connectionStatus.connected && (
                <Badge variant="outline" className="text-xs bg-emerald-50 text-emerald-700 dark:text-emerald-300">
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                {selectedRoom.hasSeaView && (
                  <Badge variant="outline" className="text-cyan-600 dark:text-cyan-400">Sea View</Badge>
                )}
                {selectedRoom.hasMountainView && (
                  <Badge variant="outline" className="text-emerald-600 dark:text-emerald-400">Mountain View</Badge>
                )}
                {selectedRoom.hasBalcony && (
                  <Badge variant="outline">Balcony</Badge>
                )}
                {selectedRoom.isAccessible && (
                  <Badge variant="outline" className="text-violet-600 dark:text-violet-400">Accessible</Badge>
                )}
                {selectedRoom.isSmoking && (
                  <Badge variant="outline" className="text-amber-600 dark:text-amber-400">Smoking</Badge>
                )}
              </div>
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center justify-between">
                      ...
                      {roomBooking.primaryGuest.isVip && (
                        <Badge variant="outline" className="text-amber-600 dark:text-amber-400">VIP</Badge>
                      )}
                    </div>
