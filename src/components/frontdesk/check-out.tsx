    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-2 sm:grid-cols-4">
        ...
        <Card className="p-4 border-l-4 border-l-amber-500">
          <div className="text-2xl font-bold text-amber-600">{stats.checkingOut}</div>
          <div className="text-xs text-muted-foreground">Checking Out</div>
        </Card>
        <Card className="p-4 border-l-4 border-l-rose-500">
          <div className="text-2xl font-bold text-rose-600">{stats.withBalance}</div>
          <div className="text-xs text-muted-foreground">Outstanding Balance</div>
        </Card>
        <Card className="p-4 border-l-4 border-l-violet-500">
          <div className="text-2xl font-bold text-violet-600">{stats.vip}</div>
                  ...
                  <CardContent>
                    ...
                    <div className="space-y-1">
                      ...
                      <div className={cn(
                        ...
                        selectedFolio.balance > 0 ? "text-rose-600" : "text-emerald-600"
                      )}>
                        <span>Balance</span>
          ...
          <div className="space-y-4">
            ...
            {selectedFolio && (
              <div className="flex justify-between items-center p-3 bg-rose-50 border border-rose-200 rounded-lg">
                ...
                <span className="font-bold text-rose-600">{formatCurrency(selectedFolio.balance)}</span>
              </div>
            )}
