...
const variantConfig: Record<CardVariant, {
  ...
  emerald: {
    ...
    barColor: 'bg-emerald-300/40 dark:bg-emerald-500/30',
    barHoverColor: 'bg-emerald-400/60 dark:bg-emerald-400/50',
  ...
  violet: {
    ...
    barColor: 'bg-violet-300/40 dark:bg-violet-500/30',
    barHoverColor: 'bg-violet-400/60 dark:bg-violet-400/50',
    glowColor: 'group-hover:shadow-violet-500/20',
    iconBg: 'from-violet-500 to-purple-600',
  },
  cyan: {
    iconGradient: 'bg-gradient-to-br from-cyan-400 to-blue-500',
    topBarGradient: 'bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-500',
    barColor: 'bg-cyan-300/40 dark:bg-cyan-500/30',
    barHoverColor: 'bg-cyan-400/60 dark:bg-cyan-400/50',
  ...
  amber: {
    ...
    barColor: 'bg-amber-300/40 dark:bg-amber-500/30',
    barHoverColor: 'bg-amber-400/60 dark:bg-amber-400/50',
    ...
    >
      <Card
        className={cn(
          ...
          config.glowColor,
          isNeumorphism
            ? 'border-0 shadow-[6px_6px_12px_var(--neu-shadow-dark),-6px_-6px_12px_var(--neu-shadow-light)]'
            : isGlassmorphism
              ? 'border border-white/20 bg-card/60 backdrop-blur-xl shadow-lg'
                ...
                <div className="flex items-center gap-1.5 pt-1">
                  <span
                    className={cn(
                      ...
                      trend === 'neutral' &&
                        'bg-muted/50 text-muted-foreground border-border dark:bg-muted/20 dark:border-border'
                    )}
                  >
  ...
  return (
    <Card
      className={cn(
        ...
        isNeumorphism
          ? 'border-0 shadow-[6px_6px_12px_var(--neu-shadow-dark),-6px_-6px_12px_var(--neu-shadow-light)]'
          : 'border border-destructive/30 shadow-md bg-card'
      )}
    >
