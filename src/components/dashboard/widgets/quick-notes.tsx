...
const CATEGORY_OPTIONS: { value: NoteCategory; label: string; color: string }[] = [
  { value: 'general', label: 'General', color: 'text-slate-600 bg-slate-50 dark:text-slate-400 dark:bg-slate-900/20' },
  { value: 'vip-alert', label: 'VIP Alert', color: 'text-violet-600 bg-violet-50 dark:text-violet-400 dark:bg-violet-900/20' },
  { value: 'maintenance', label: 'Maintenance', color: 'text-amber-600 bg-amber-50 dark:text-amber-400 dark:bg-amber-900/20' },
  { value: 'housekeeping', label: 'Housekeeping', color: 'text-emerald-600 bg-emerald-50 dark:text-emerald-400 dark:bg-emerald-900/20' },
  { value: 'front-desk', label: 'Front Desk', color: 'text-sky-600 bg-sky-50 dark:text-sky-400 dark:bg-sky-900/20' },
];
          ...
          <div className="flex items-center gap-2">
            <span
              className={cn(
                ...
                charPercentage >= 90 ? 'text-red-500 font-medium' : 'text-muted-foreground'
              )}
            >
              {charCount}/{MAX_CHARS}
            </span>
