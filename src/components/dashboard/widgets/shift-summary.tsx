      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-4 gap-2">
          ...
          >
            ...
            <p className="text-lg font-bold text-emerald-600 dark:text-emerald-400 tabular-nums leading-none">{data.checkIns}</p>
          ...
          >
            ...
            <p className="text-lg font-bold text-orange-600 dark:text-orange-400 tabular-nums leading-none">{data.checkOuts}</p>
          ...
          >
            <DollarSign className="h-3.5 w-3.5 text-sky-600 dark:text-sky-400 mx-auto mb-1" />
