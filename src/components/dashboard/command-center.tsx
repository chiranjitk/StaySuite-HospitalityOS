...
function TaskItem({ task }: { task: Task }) {
  ...
  const statusConfig = {
    ...
    in_progress: { color: 'bg-cyan-100 text-cyan-700', icon: Loader2 },
  ...
  return (
    <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors cursor-pointer group">
      ...
      <StatusIcon className={cn(
        ...
        task.status === 'in_progress' && "text-cyan-600 animate-spin",
      ...
      <Card className="border-0 shadow-sm">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
            ...
            <span className="text-2xl font-bold text-emerald-600">{data.upcomingCheckIns}</span>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 rounded-lg bg-muted/50">
            ...
            <span className="text-2xl font-bold text-violet-600">{data.staffOnDuty}</span>
          </div>
