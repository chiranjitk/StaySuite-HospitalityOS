...
export function StatsBar() {
  ...
  return (
    <div className="relative group/stats">
      ...
      <div className="flex gap-3 overflow-x-auto pb-1 snap-x snap-mandatory scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent hover:scrollbar-thumb-muted-foreground/20">
        {stats.map((stat, i) => (
          <motion.div
            key={stat.id}
