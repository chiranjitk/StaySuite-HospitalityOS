                ...
                {data.topMarkets.map((market, i) => (
                  <div key={market.market} className="flex items-center justify-between p-3 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <Badge variant="secondary" className={market.growth >= 0 ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400'}>
                  ...
                  {data.bookingPatterns.seasonality.map((quarter) => (
                    <Card key={quarter.quarter} className="bg-muted/30">
                      <CardContent className="p-4 text-center">
                        ...
                        <p className="text-2xl font-bold text-emerald-600 dark:text-emerald-400">{quarter.bookings}</p>
                        <p className="text-sm text-muted-foreground">bookings</p>
                        <Badge variant="secondary" className={cn('mt-2', quarter.growth >= 0 ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400' : 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400')}>
                ...
                {data.segmentRevenue.segments.map((segment, index) => (
                  <div key={segment.name} className="p-4 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                    ...
                    <div className="flex items-center justify-between text-sm mb-2">
                      ...
                      <span className="font-bold text-emerald-600 dark:text-emerald-400">{formatCurrency(segment.revenue)}</span>
                    </div>
