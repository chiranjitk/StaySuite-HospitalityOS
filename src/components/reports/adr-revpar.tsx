      ...
      <CardContent className="pt-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <div className={`flex items-center gap-1 mt-1 text-xs ${isPositive ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-500 dark:text-red-400'}`}>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
        <MetricCard
          ...
          change={adrChange}
          icon={<DollarSign className="h-6 w-6 text-emerald-700 dark:text-emerald-300" />}
        ...
        <MetricCard
          ...
          change={revparChange}
          icon={<Target className="h-6 w-6 text-amber-700 dark:text-amber-300" />}
        ...
        <MetricCard
          ...
          icon={<BarChart3 className="h-6 w-6 text-cyan-700 dark:text-cyan-300" />}
