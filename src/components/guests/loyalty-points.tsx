                  ...
                  return (
                    <div
                      ...
                      className={cn(
                        ...
                        isSelected ? 'border-emerald-500 bg-emerald-50 dark:bg-emerald-950/30' : 'hover:bg-muted/50',
                    ...
                    >
                      ...
                      {!canRedeem && (
                        <p className="text-xs text-red-500 dark:text-red-400 mt-1">Insufficient points</p>
                      )}
                    </div>
                  );
                })}
