...
export default function GuestSegments() {
  ...
  const getTierColor = (tier: string) => {
    const colors: Record<string, string> = {
      bronze: 'bg-amber-100 text-amber-800 dark:text-amber-200',
      silver: 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300',
      gold: 'bg-yellow-100 text-yellow-800 dark:text-yellow-200',
      platinum: 'bg-purple-100 text-purple-800 dark:text-purple-200',
    };
    return colors[tier] || 'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-300';
  };
