                  ...
                  <div className="flex flex-col md:flex-row gap-3 sm:gap-4 md:items-start justify-between">
                    ...
                    {campaign.status === 'sent' && (
                      <div className="flex gap-6 text-sm">
                        ...
                        <div className="text-center">
                          <p className="font-semibold text-emerald-600">{campaign.openRate}%</p>
                          <p className="text-muted-foreground">Opened</p>
                        </div>
                        <div className="text-center">
                          <p className="font-semibold text-cyan-600">{campaign.clickRate}%</p>
              ...
              {viewingCampaign.status === 'sent' && (
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4">
                  ...
                  <div className="text-center p-4 bg-emerald-50 dark:bg-emerald-950 rounded-lg">
                    <p className="text-2xl font-bold text-emerald-600">{viewingCampaign.openedCount}</p>
                  ...
                  <div className="text-center p-4 bg-cyan-50 dark:bg-cyan-950 rounded-lg">
                    <p className="text-2xl font-bold text-cyan-600">{viewingCampaign.clickedCount}</p>
                    <p className="text-sm text-muted-foreground">Clicked ({viewingCampaign.clickRate}%)</p>
                  </div>
                  <div className="text-center p-4 bg-red-50 dark:bg-red-950 rounded-lg">
                    <p className="text-2xl font-bold text-red-600">{viewingCampaign.bouncedCount}</p>
