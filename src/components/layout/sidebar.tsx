...
const keyframeStyles = `
  .text-glow {
    text-shadow: 0 0 20px rgba(var(--sidebar-primary), 0.2);
  }
  ...
  @keyframes activeGlow {
    0%, 100% { box-shadow: 0 0 8px rgba(20, 184, 166, 0.15); }
    50% { box-shadow: 0 0 16px rgba(20, 184, 166, 0.25); }
  }
  .active-glow {
        ...
        <TooltipTrigger asChild>
          <Link
            ...
            className={cn(
              ...
              isActive
                ? "bg-gradient-to-r from-teal-500/10 to-emerald-500/5 text-teal-500 active-glow"
                : "text-sidebar-foreground hover:bg-sidebar-accent/40 hover:text-sidebar-foreground"
            )}
          >
            {isActive && (
              <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-5 bg-gradient-to-b from-teal-500 to-emerald-500 rounded-r-full shadow-[0_0_12px_rgba(20,184,166,0.5)]" />
            )}
            <item.icon className="h-4 w-4" />
            {item.badge && (
              <span className="absolute -top-0.5 -right-0.5 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 text-white text-[9px] font-bold px-1 animate-pulse">
                {item.badge}
              </span>
            )}
          </Link>
  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive
          ? "bg-gradient-to-r from-teal-500/[0.08] via-teal-500/[0.04] to-transparent text-teal-600 dark:text-teal-400 active-glow"
          : "text-sidebar-foreground hover:text-sidebar-foreground hover:bg-sidebar-accent/40 hover:scale-[1.01]"
      )}
    >
      {/* Active left gradient accent bar - 3px with teal-to-emerald gradient */}
      <div className={cn(
        "absolute left-0 top-1/2 -translate-y-1/2 w-[3px] rounded-r-full transition-all duration-300 ease-out",
        isActive
          ? "h-5 bg-gradient-to-b from-teal-500 to-emerald-500 shadow-[0_0_12px_rgba(20,184,166,0.4)]"
          : "h-0 bg-transparent group-hover/item:h-2 group-hover/item:bg-sidebar-primary/30"
      )} />
      ...
      <div className={cn(
        ...
        isActive
          ? "bg-gradient-to-br from-teal-500/15 to-emerald-500/10 text-teal-600 dark:text-teal-400 shadow-sm shadow-teal-500/10"
      ...
      {item.badge && (
        <span className={cn(
          ...
          isActive
            ? "bg-gradient-to-r from-teal-500/20 to-emerald-500/15 text-teal-600 dark:text-teal-400"
          ...
          <span className={cn(
            ...
            isActive ? "bg-teal-500" : "bg-sidebar-foreground/50"
          )} />
        </span>
      )}
    </Link>
    ...
    <div>
      ...
      >
        ...
        <div className={cn(
          ...
          hasActiveItem 
            ? "bg-gradient-to-br from-teal-500/20 to-emerald-500/10 text-teal-500" 
      ...
      <div className="relative group/search">
        ...
        <Input
          ...
          className={cn(
            ...
            "focus-visible:bg-sidebar-accent/40 focus-visible:border-teal-500/20",
      ...
      <div className="flex items-center gap-3 px-2 py-2 rounded-xl bg-sidebar-accent/[0.12] border border-sidebar-border/[0.08]">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            <BedDouble className="h-3 w-3 text-emerald-400 flex-shrink-0" />
            <span className="text-[11px] font-semibold text-sidebar-foreground tabular-nums">78%</span>
          </div>
          ...
          <div className="mt-1 h-1 rounded-full bg-sidebar-accent/30 overflow-hidden">
            <div 
              className={cn("h-full rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 stat-bar-grow", mounted ? "w-[78%]" : "w-0")}
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-1.5">
            ...
            <span className="text-[11px] font-semibold text-sidebar-foreground tabular-nums">$12.4K</span>
          </div>
          <p className="text-[9px] text-sidebar-foreground mt-0.5 uppercase tracking-wider">Revenue</p>
          {/* Mini gradient bar */}
          <div className="mt-1 h-1 rounded-full bg-sidebar-accent/30 overflow-hidden">
            <div 
              className={cn("h-full rounded-full bg-gradient-to-r from-teal-500 to-emerald-500 stat-bar-grow", mounted ? "w-[62%]" : "w-0")}
...
function UserProfile({ collapsed }: { collapsed?: boolean }) {
  ...
  return (
    <div className="px-3 py-3 flex-shrink-0">
      ...
      <div className="h-px mb-3 bg-gradient-to-r from-transparent via-teal-500/20 to-transparent" />
      <div className="flex items-center gap-3 p-2.5 rounded-xl bg-sidebar-accent/[0.12] border border-sidebar-border/[0.08] hover:bg-sidebar-accent/20 hover:border-sidebar-border/15 transition-all duration-200 cursor-pointer group/profile hover:-translate-y-[1px] hover:shadow-lg hover:shadow-teal-500/[0.05]">
        {/* Avatar with online status dot */}
        <div className="relative flex-shrink-0">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-teal-500/25 to-emerald-500/15 text-teal-600 dark:text-teal-400 text-xs font-bold transition-all duration-200 group-hover/profile:from-teal-500/30 group-hover/profile:to-emerald-500/20 shadow-sm shadow-teal-500/10">
            {initials}
          </div>
        ...
        <div className="flex-shrink-0">
          <span className={cn(
            ...
            isAdmin 
              ...
              : "bg-gradient-to-r from-teal-500/15 to-emerald-500/10 text-teal-600 dark:text-teal-400 border border-teal-500/15 shadow-sm shadow-teal-500/10"
          )}>
    ...
    <div className={cn(
      ...
      <Link href="/" className={cn("group/logo", collapsed && "flex justify-center")} onClick={onClose}>
        <div className="flex items-center gap-3">
          ...
          >
            {/* Outer glow ring */}
            <div className="absolute inset-0 rounded-xl bg-gradient-to-br from-teal-500/30 to-emerald-500/20 blur-md opacity-0 group-hover/logo:opacity-100 transition-opacity duration-500" />
            <div className={cn(
              "relative flex items-center justify-center rounded-xl transition-all duration-300",
              "bg-gradient-to-br from-teal-500 to-emerald-500",
              "shadow-lg shadow-teal-500/25",
              "group-hover/logo:shadow-xl group-hover/logo:shadow-teal-500/40",
            ...
            {!collapsed && (
              <div className="absolute -top-1.5 -right-1.5 flex items-center justify-center w-4 h-4 rounded-full bg-sidebar border border-sidebar-border/30">
                <ThemeIcon className="h-2 w-2 text-teal-500" />
              </div>
            )}
          </motion.div>
              ...
              <TooltipTrigger asChild>
                <Link
                  ...
                  className={cn(
                    ...
                    "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sidebar-primary/40 focus-visible:ring-offset-1 focus-visible:ring-offset-sidebar",
                    isActive
                      ? "bg-gradient-to-r from-teal-500/10 to-emerald-500/5 text-teal-500"
                      : "text-sidebar-foreground hover:bg-sidebar-accent/35 hover:text-sidebar-foreground"
                  )}
                >
                  {isActive && (
                    <div className="absolute left-0 top-1/2 -translate-y-1/2 w-[3px] h-4 bg-gradient-to-b from-teal-500 to-emerald-500 rounded-r-full shadow-[0_0_10px_rgba(20,184,166,0.4)]" />
                  )}
                  <section.icon className="h-4 w-4" />
                  {/* Notification indicator for section */}
                  {visibleItems.some(item => item.badge) && (
                    <span className="absolute top-1 right-1 h-1.5 w-1.5 rounded-full bg-teal-500 animate-pulse" />
                  )}
                </Link>
              </TooltipTrigger>
              <TooltipContent side="right" sideOffset={8} className="text-xs font-medium bg-sidebar-accent/95 backdrop-blur-xl border-sidebar-border/30 text-sidebar-foreground">
...
export function Sidebar({ className, mobileOpen = false, onMobileClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <div 
        className={cn(
          "fixed inset-0 z-40 bg-black/50 backdrop-blur-md transition-all duration-300 lg:hidden",
