...
export function Header({ className, onMenuClick }: HeaderProps) {
  ...
  const quickActions = [
    { label: tNav('allBookings'), icon: CalendarPlus, section: 'bookings-calendar', color: 'text-blue-500', permission: 'bookings-calendar' },
    { label: tNav('checkIn'), icon: UserPlus, section: 'frontdesk-checkin', color: 'text-emerald-500', permission: 'frontdesk-checkin' },
    { label: tNav('serviceRequests'), icon: Sparkles, section: 'experience-requests', color: 'text-purple-500', permission: 'experience-requests' },
      ...
      <div className="flex items-center gap-2 md:gap-4 min-w-0 flex-shrink">
        ...
        <div className="flex flex-col">
          <h1 className="text-base md:text-lg font-semibold flex items-center gap-2 truncate group/logo">
            ...
            <span className="bg-gradient-to-r from-foreground to-foreground/70 bg-clip-text text-transparent transition-all duration-200 relative">
              {getSectionTitle()}
            </span>
          </h1>
