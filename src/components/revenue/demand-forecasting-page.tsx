          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-cyan-900 dark:text-cyan-100">{data.metrics.bookingPace}x</p>
                    ...
                    <div key={season.season} className="p-4 rounded-lg bg-muted/30">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <Badge variant="secondary" className={season.trend >= 0 ? 'bg-emerald-100 text-emerald-700' : 'bg-red-100 text-red-700'}>
          ...
          <Card className="border-0 shadow-sm bg-gradient-to-r from-cyan-50 to-teal-50 dark:from-cyan-950 dark:to-teal-950">
            <CardContent className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-lg">Current Seasonal Factor: {data.metrics.seasonalFactor}x</h3>
                  ...
                  <div className="flex items-center gap-4 mt-3">
                    <div className="flex items-center gap-2">
                      ...
                      <Badge variant="secondary">{data.metrics.pickupRate} rooms/day</Badge>
                    </div>
                  </div>
                </div>
              </div>
