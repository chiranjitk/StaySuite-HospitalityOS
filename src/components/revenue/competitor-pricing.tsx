                ...
                <div className="flex items-center gap-1 mt-1">
                  {data.marketPosition === 'above' ? (
                    <>
                      ...
                      <span className="text-xs text-red-500">{data.priceDifference}% above</span>
                    </>
                  ) : data.marketPosition === 'below' ? (
                    <>
                      <TrendingDown className="h-3 w-3 text-emerald-500" />
                      <span className="text-xs text-emerald-500">{Math.abs(data.priceDifference)}% below</span>
                    </>
                  ) : (
                    <>
                      ...
                      <div className="text-right">
                        ...
                        <div className="flex items-center gap-1">
                          {diff > 0 ? (
                            <>
                              <TrendingUp className="h-3 w-3 text-red-500" />
                              <span className="text-xs text-red-500">+{diff.toFixed(1)}%</span>
                            </>
                          ) : diff < 0 ? (
                            <>
                              <TrendingDown className="h-3 w-3 text-emerald-500" />
