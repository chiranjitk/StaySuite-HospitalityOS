        ...
        <div className="flex items-start justify-between gap-4">
          <div className="flex items-start gap-4">
            <div className={`p-2 rounded-lg ${
              ...
              {suggestion.type === 'pricing' && <DollarSign className="h-5 w-5 text-emerald-600" />}
              {suggestion.type === 'marketing' && <Target className="h-5 w-5 text-violet-600" />}
              {suggestion.type === 'operations' && <Settings className="h-5 w-5 text-cyan-600" />}
              {suggestion.type === 'revenue' && <TrendingUp className="h-5 w-5 text-amber-600" />}
            </div>
