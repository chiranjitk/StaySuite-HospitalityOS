          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-emerald-900 dark:text-emerald-100">{data.avgPredictedOccupancy}%</p>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-amber-900 dark:text-amber-100">{data.accuracy}%</p>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-violet-900 dark:text-violet-100">{data.peakDays.length}</p>
          ...
          <CardContent className="pt-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-cyan-900 dark:text-cyan-100">{data.seasonalFactor}x</p>
              ...
              >
                <div className="flex items-start gap-3">
                  <div className={`mt-0.5 ${
                    ...
                    insight.type === 'warning' ? 'text-amber-600' : 'text-muted-foreground'
                  }`}>
                    {insight.type === 'opportunity' ? (
        ...
        <Card className="border-0 shadow-sm">
          ...
          <CardContent>
            <div className="max-h-[350px] overflow-y-auto space-y-2 pr-2">
              {data.forecastData.slice(0, 14).map((day) => (
                <div
                  key={day.date}
