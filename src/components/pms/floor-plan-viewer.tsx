...
const roomStatuses = [
  { value: 'available', label: 'Available', color: 'bg-emerald-500', borderColor: 'border-emerald-500', textColor: 'text-white' },
  { value: 'occupied', label: 'Occupied', color: 'bg-blue-500', borderColor: 'border-blue-500', textColor: 'text-white' },
  { value: 'dirty', label: 'Dirty', color: 'bg-yellow-500', borderColor: 'border-yellow-500', textColor: 'text-yellow-950' },
  { value: 'maintenance', label: 'Maintenance', color: 'bg-orange-500', borderColor: 'border-orange-500', textColor: 'text-white' },
  { value: 'out_of_order', label: 'Out of Order', color: 'bg-red-500', borderColor: 'border-red-500', textColor: 'text-white' },
];
