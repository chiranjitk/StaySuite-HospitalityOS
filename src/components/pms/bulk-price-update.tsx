  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          title: 'Error',
          description: result.error?.message || 'Failed to update prices',
          variant: 'destructive',
        });
      }
    } catch {
                        ...
                        <TableRow key={idx}>
                          ...
                          <TableCell>
                            <Badge
                              variant="secondary"
                              className={cn(
                                change > 0 && 'text-green-600 dark:text-green-400 bg-green-50',
                                change < 0 && 'text-red-600 dark:text-red-400 bg-red-50'
                              )}
                            >
