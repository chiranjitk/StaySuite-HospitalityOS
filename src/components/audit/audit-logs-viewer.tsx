...
const moduleColors: Record<string, string> = {
  ...
  bookings: 'bg-green-500/10 text-green-600 border-green-200',
  guests: 'bg-cyan-500/10 text-cyan-600 border-cyan-200',
  rooms: 'bg-orange-500/10 text-orange-600 border-orange-200',
  billing: 'bg-amber-500/10 text-amber-600 border-amber-200',
  inventory: 'bg-rose-500/10 text-rose-600 border-rose-200',
  housekeeping: 'bg-teal-500/10 text-teal-600 border-teal-200',
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="p-0">
          {error && <div className="p-4 bg-red-50 text-red-600 border-b">{error}</div>}
          ...
          {selectedLog && (
            <div className="space-y-4">
              ...
              {selectedLog.oldValue && Object.keys(selectedLog.oldValue).length > 0 && (
                <div>
                  <label className="text-sm text-muted-foreground flex items-center gap-2">
                    <XCircle className="h-4 w-4 text-red-500" /> Old Value
                  </label>
              ...
              {selectedLog.newValue && Object.keys(selectedLog.newValue).length > 0 && (
                <div>
                  <label className="text-sm text-muted-foreground flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-green-500" /> New Value
                  </label>
