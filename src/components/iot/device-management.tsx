    ...
    return (
      <div className="flex items-center gap-2">
        ...
        <Badge variant={statusBadgeVariants[status] || 'secondary'} className={cn(
          status === 'online' && 'bg-emerald-100 text-emerald-700 border border-emerald-200',
                    ...
                    <TableRow key={device.id} className="transition-colors hover:bg-muted/60 hover:shadow-sm">
                      ...
                      <TableCell>
                        <Badge variant="outline" className={cn('capitalize',
                          device.type === 'thermostat' && 'border-orange-300 text-orange-700 bg-orange-50',
                          device.type === 'light' && 'border-yellow-300 text-yellow-700 bg-yellow-50',
                          device.type === 'lock' && 'border-emerald-300 text-emerald-700 bg-emerald-50',
                          device.type === 'sensor' && 'border-violet-300 text-violet-700 bg-violet-50',
                          device.type === 'tv' && 'border-cyan-300 text-cyan-700 bg-cyan-50',
                          device.type === 'blind' && 'border-pink-300 text-pink-700 bg-pink-50',
                          device.type === 'ac' && 'border-sky-300 text-sky-700 bg-sky-50'
                        )}>{device.type}</Badge>
                      </TableCell>
                      <TableCell>
                        <div>
