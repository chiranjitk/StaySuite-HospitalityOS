...
const roomStatuses = [
  { value: 'available', label: 'Available', color: 'bg-emerald-500', textColor: 'text-white', icon: CheckCircle2 },
  { value: 'occupied', label: 'Occupied', color: 'bg-violet-500', textColor: 'text-white', icon: User },
  { value: 'dirty', label: 'Dirty', color: 'bg-amber-500', textColor: 'text-white', icon: Bed },
  { value: 'cleaning', label: 'Cleaning', color: 'bg-cyan-500', textColor: 'text-white', icon: Sparkles },
  { value: 'inspected', label: 'Inspected', color: 'bg-blue-500', textColor: 'text-white', icon: Eye },
  { value: 'maintenance', label: 'Maintenance', color: 'bg-orange-500', textColor: 'text-white', icon: Wrench },
  { value: 'out_of_order', label: 'Out of Order', color: 'bg-red-500', textColor: 'text-white', icon: XCircle },
];
        ...
        <Card className="p-4">
          <div className="flex items-center gap-2">
            <div className="p-2 rounded-lg bg-amber-500/10">
              <Bed className="h-4 w-4 text-amber-500 dark:text-amber-400" />
            </div>
            <div>
