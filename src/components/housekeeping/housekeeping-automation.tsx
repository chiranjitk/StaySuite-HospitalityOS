            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center gap-2 flex-wrap">
                  <Badge variant="outline" className="border-red-300 text-red-700">Dirty</Badge>
                  <ArrowRight className="h-3 w-3 text-muted-foreground" />
                  <Badge variant="outline" className="border-yellow-300 text-yellow-700">Cleaning</Badge>
                  <ArrowRight className="h-3 w-3 text-muted-foreground" />
                  <Badge variant="outline" className="border-blue-300 text-blue-700">Inspected</Badge>
                  <ArrowRight className="h-3 w-3 text-muted-foreground" />
                  <Badge variant="outline" className="border-green-300 text-green-700">Clean/Available</Badge>
                </div>
                <Separator />
                <div className="space-y-2 text-sm">
                  <div className="flex items-start gap-2">
                    <span className="text-red-500 font-medium min-w-[80px]">Dirty:</span>
                    <span className="text-muted-foreground">Room needs cleaning (auto-set on checkout)</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-yellow-600 font-medium min-w-[80px]">Cleaning:</span>
                    <span className="text-muted-foreground">Staff is actively cleaning the room</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-blue-600 font-medium min-w-[80px]">Inspected:</span>
                    <span className="text-muted-foreground">Cleaning done, awaiting supervisor inspection</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-green-600 font-medium min-w-[80px]">Clean:</span>
