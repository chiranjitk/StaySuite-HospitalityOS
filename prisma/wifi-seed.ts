...
// DHCP Subnet IDs
const SUBNET_IDS = {
  guest: 'dhcp-sub-guest',
  staff: 'dhcp-sub-staff',
  iot: 'dhcp-sub-iot',
  mgmt: 'dhcp-sub-mgmt',
};
...
const BW_POLICY_IDS = {
  free: 'bwpolicy-free',
  standard: 'bwpolicy-standard',
  premium: 'bwpolicy-premium',
};
    ...
    data: [
      {
        ...
        tenantId: TENANT_ID,
        propertyId: PROPERTY_ID,
        name: 'Hotel Guest Portal',
        description: 'Main captive portal for hotel guests with voucher and room number authentication.',
        listenIp: '192.168.10.1',
        listenPort: 80,
        useSsl: false,
        sslCertPath: null,
        sslKeyPath: null,
      ...
      },
      {
        ...
        propertyId: PROPERTY_ID,
        name: 'Staff Portal',
        description: 'Staff-only captive portal with PMS credentials authentication.',
        listenIp: '192.168.20.1',
        listenPort: 80,
        useSsl: false,
        sslCertPath: null,
        sslKeyPath: null,
        ...
        idleTimeout: 1800,
        redirectUrl: 'https://staff.royalstay.in/dashboard',
        successMessage: 'Welcome back! Staff WiFi connected.',
        failMessage: 'Invalid credentials. Please use your PMS login.',
      },
    ],
  });
