...
// import { seedWiFiData } from './wifi-seed'; // Disabled: user wants clean DB without WiFi seed data
...
async function main() {
  ...
  // await seedWiFiData(); // Disabled: user wants clean DB without WiFi seed data
